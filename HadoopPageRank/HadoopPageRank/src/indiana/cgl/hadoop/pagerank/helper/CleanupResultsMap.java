...
public class CleanupResultsMap extends Mapper<LongWritable, Text, DoubleWritable, Text> {
	...
	throws IOException, InterruptedException {
		...
		context.write(new DoubleWritable(rrd.rankValue), new Text(String.valueOf(rrd.sourceUrl)));
		}
